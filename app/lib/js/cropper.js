...
/***/ function(module, exports, __webpack_require__) {
	...
	_jquery2['default'].fn.cropit = function (method) {
	  ...
	  } else if (['rotateCW', 'rotateCCW', 'disable', 'reenable','clearImg','cancelImg'].indexOf(method) >= 0) {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function init() {
	      ...
	      this.$imageContainer = (0, _jquery2['default'])('<div />').addClass(_constants.CLASS_NAMES.PREVIEW_IMAGE_CONTAINER).css({
           ...
           this.$imageContainer.append(" <div>Drop image here to upload</div>");
	      ...
	      if (this.options.imageState && this.options.imageState.src) {
            ...
            document.querySelector("#image_option_disabled_pannel").style.display = "none";
	      }else{
                document.querySelector("#export_image").style.display = "none";
                document.querySelector("#image_option_disabled_pannel").style.display = "block";
               document.querySelector("#cancel_image").style.display = "none";
          }
	    }
	  }, {
	    key: 'bindListeners',
        ...
        //document.getElementById('upload_ad_label').innerHTML = "Replace Image";   
        document.querySelector(".image-editor").style.visibility = "visible";
        document.querySelector("#confired_image").style.visibility = "hidden";
        document.querySelector("#export_image").style.display = "inline-block";
        document.querySelector("#delete_image").style.display = "none";
        document.querySelector("#upload_ad_label").style.display = "none";
        document.querySelector("#cancel_image").style.display = "inline-block";
        document.querySelector("#confired_image").src = null;
        document.querySelector(".cropit-preview-image").visibility = "visible"; 
        document.querySelector("#banner_descprition_to_cut").style.display = "block";
        document.querySelector("#banner_descprition_default").style.display = "none";
        document.querySelector("#image_option_disabled_pannel").style.display = "none";
        ...
        document.querySelector("#export_image").style.display = "inline-block";
            ...
            /*
	   document.getElementById('upload_ad_label').innerHTML = "Select Image";   
        document.querySelector(".image-editor").style.visibility = "visible";
        document.querySelector("#confired_image").style.visibility = "hidden";
        document.querySelector("#delete_image").style.visibility = "hidden";
        document.querySelector("#export_image").style.display = "inline-block";
       */
	    }
	  }, {
	...
	var Zoomer = (function () {
	  ...
	  _createClass(Zoomer, [{
	    ...
	    value: function setup(_ref) {
	      ...
	      var widthRatio = (previewSize.width + 200) / imageSize.width;
          ...
          if(imageSize.width > 664 && imageSize.width < 864)
            {
                this.minZoom =   widthRatio;
            }
            else if(imageSize.width < 664)
            {
                   this.minZoom =  previewSize.width / imageSize.width;
            }
